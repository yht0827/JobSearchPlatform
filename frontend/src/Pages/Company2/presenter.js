...
const Company2 = ({ action, ChangeAction, steps, changeNextStep, stepReset, current, handleLoader, isLoaded }) => (
    <> 
        <Header title="LG" link="/company2" onClick={() => { stepReset(); handleLoader(true); }} bg="white" fg={oc.red[7]} gr1={oc.pink[6]} gr2={oc.red[7]}>
        ...
        <Section>
            ...
            && <FormWrapper bg={oc.red[8]} BoxWid="1000px" BoxHei="750px" LogoName="Application"> 
                <ApplyTemPlate companyNm={"Company2"} questions={questions[1]} btcolor="red" icolor={oc.red[7]} subcolor="pink" bg={oc.red[3]} steps={steps} changeNextStep={changeNextStep} current={current} stepReset={stepReset} handleLoader={handleLoader} isLoaded={isLoaded} />
            </FormWrapper> }
        </Section>
    </>
);
